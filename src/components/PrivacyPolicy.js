...
A.	Personal data including but not limited to business entity’s name, nature of business entity, registered office address, contact details (official email and mobile number), constituting document.
B.	Information collected through permission derived by the platform. For location access, and storage permissions etc.
...
V.	Right to object – the right to object to us processing your personal data on grounds relating to your particular situation. Along with the right to object to your personal data being processed for direct marketing purposes,
Vi.	Right to data portability – the right to request a copy of your personal data in electronic format and the right to transmit that personal data for use in another part’s service,
...
To withdraw your consent, or to request the download or delete your data with us for any or all our services at any time, please contact us at info@kidzsport.World
              </p>
            </div>
