        ...
        <img src={circlewhite} alt="" className="circlewhite circlewhite-one floating" />
                ...
                <div className='row align-items-center'>
                  ...
                  <div className='col-lg-6'>
                    <div class="input-group">
                      <input class="form-control" placeholder="Enter Email Here" type="text" name="email" />
                      <button type="submit" class="btn btn-primary input-group-append">Subscribe Now</button>
                    </div>
                  </div>
                </div>
          ...
          <div className='row' style={{ position: 'relative', zIndex: 1 }}>
            <div className='col-lg-4'>
              ...
              <p className='quote-footer-company '>Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi. Aliquam in hendrerit urna.</p>
            ...
            <div className='col-lg-2'>
              ...
              <a href="#"><p className='footer-links'>Privacy Policy</p></a>
            ...
            <div className='col-lg-3'>
              ...
              <div className='d-inline-flex gap-2 mb-2'>
                <div><img src={galleryimage} alt="" className="galleryimage" /></div>
                <div><img src={galleryimage} alt="" className="galleryimage" /></div>
                <div><img src={galleryimage} alt="" className="galleryimage" /></div>
          ...
          <div className='copyright'>
            <div className='container'>
            <p>Copyright © 2024 Kidzsport World All Rights Reserved</p>
            </div>
          </div>
